...
class configure:
    ...
    def chooseHHG(self, idEntry, rangeCombo, powCombo, freqCombo, sampCombo, sysTimeEntry, sysTime, stpTime, lastStartEntry, lastStpEntry):
    ...
    def syncSettings(self, idEntry, rangeCombo, powCombo, freqCombo, sampCombo, sysTimeEntry, sysTime, stpTime):
	confhhg_path = sys.argv[1]	
...
class conf_HHG_dialog:
	...
	self.confer = configure()
        ...
        self.builder.add_from_file("/home/hany/bin/HHG4.ui")
	...
	self.confer.chooseHHG(self.idEntry, self.rangeCombo, self.powCombo, self.freqCombo, self.sampCombo, self.sysTimeEntry, self.sysTime, self.stpTime, 			   					self.lastStartEntry,self.lastStpEntry)					   		
    ...
    def SyncButtonClick(self, widget):
   	self.confer.syncSettings(self.idEntry,self.rangeCombo, self.powCombo, self.freqCombo, self.sampCombo, self.sysTimeEntry, self.sysTime, self.stpTime)
